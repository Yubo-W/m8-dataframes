...
grant.mean <- sum(spending)/length(spending)
...
largest.org <- org[spending == largest]

# Which organization received the smallest grant?
smallest.org <- org[spending == smallest]

# How many grants were awarded in 2010?
num.grants <- length(spending[grants$start_year == 2010])
